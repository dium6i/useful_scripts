...
Update Log:
    ...
    2024-01-07: Edited some function descriptions. 
...
def process_xml(xml_path, size_ratio):
    ...
    Returns:
        label_counts (dict): Label counts. 
        label_ratios (dict): Label size ratios. 
    '''
    ...
    else: # Ignore ".ipynb_checkpoints" when using jupyter
        pass
...
def merge_counts(label_counts, label_ratios, new_lc, new_lr):
    '''
    Merge the results of all XML files for both labels and label ratios. 
...
def count(xmls, size_ratio):
    ...
    Args:
        xmls (string): Directory of annotations. 
        size_ratio (boolean): Weather to count label size ratio. 
...
def build_results_dir(xmls):
    ...
    Returns:
        save_dir (string): Directory to save results. 
        ratios_dir (string): Directory of ratio results. 
    '''
...
if __name__ == '__main__':
    # Setting parameters
    xmls = 'path/of/annotation/folder' # Directory of annotations. 
